<template>
    <div class="faq">
      <div class="container">
        <div class="col-md-12">
          <div class="row">
            <h2 class="label1 text-center">FAQ</h2>
          </div>
        </div>
        <div class="col-md-12">
          <div class="row">
            <div class="accordion" id="">
              ...
              <div class="accordion-item">
                <h2 class="accordion-header" id="main2">
                  <button
              ...
              <div class="accordion-item">
                <h2 class="accordion-header" id="main3">
                  <button
                      class="accordion-button collapsed"
                      type="button"
                      data-bs-toggle="collapse"
              ...
              <div class="accordion-item">
                <h2 class="accordion-header" id="main4">
                  <button
                      class="accordion-button collapsed"
                      type="button"
                      data-bs-toggle="collapse"
              ...
              <div class="accordion-item">
                <h2 class="accordion-header" id="main5">
                  <button
                      class="accordion-button collapsed"
                      type="button"
                      data-bs-toggle="collapse"
              ...
              <div class="accordion-item">
                <h2 class="accordion-header" id="main6">
                  <button
                      class="accordion-button collapsed"
                      type="button"
                      data-bs-toggle="collapse"
              ...
              <div class="accordion-item">
                <h2 class="accordion-header" id="main7">
                  <button
                      class="accordion-button collapsed"
                      type="button"
                      data-bs-toggle="collapse"
                  ...
                  >
                    <span class="accordion-num">7.</span>Как подать заявку на внесение изменений на сайте?
                  </button>
                </h2>
                <div
                    id="collapseSeven"
                    class="accordion-collapse collapse"
                    aria-labelledby="main7"
                    data-bs-parent="#accordionExample"
                >
                  <div class="accordion-body">
                    Сайты поддерживают штатные сотрудники ООО «Инитлаб», г.
              ...
              <div class="accordion-item">
                <h2 class="accordion-header" id="main8">
                  <button
                      class="accordion-button collapsed"
                      type="button"
                      data-bs-toggle="collapse"
              ...
              <div class="accordion-item">
                <h2 class="accordion-header" id="main9">
                  <button
                      class="accordion-button collapsed"
                      type="button"
                      data-bs-toggle="collapse"
              ...
              <div class="accordion-item">
                <h2 class="accordion-header" id="main10">
                  <button
                      class="accordion-button collapsed"
                      type="button"
                      data-bs-toggle="collapse"
              ...
              <div class="accordion-item">
                <h2 class="accordion-header" id="main11">
                  <button
                      class="accordion-button collapsed"
                      type="button"
                      data-bs-toggle="collapse"
              ...
              <div class="accordion-item">
                <h2 class="accordion-header" id="main12">
                  <button
                      class="accordion-button collapsed"
                      type="button"
                      data-bs-toggle="collapse"
